...
def minorize(matrix, row, column):
    ...
    Функция возвращает минор в виде копии исходной матрицы с удаленными лишними строками и столбцами."""
    try:
...
def determinant(matrix):
    ...
    В случае, если матрица не является квадратной, возвращается ошибка.
